...
// ============ PREVIEW TRANSACTION ============
export const previewTransactionService = async (items) => {
...
export const createCashTransactionService = async (cashierId, items, cashReceived) => {
...
export const createDebitTransactionService = async (cashierId, items, cardNumber) => {
    const shift = await prisma.shift.findFirst({ where: { cashierId, status: "OPEN" } });
    if (!shift) {
        throw new ShiftNotFoundError("Cashier belum memiliki shift yang aktif");
    }
...
export const getTransactionHistoryService = async (cashierId, filters) => {
...
export const getTransactionByIdService = async (cashierId, id) => {
...
export class StockInsufficientError extends Error {
    availableStock;
    requestedQuantity;
    constructor(message, availableStock, requestedQuantity) {
        super(message);
...
export class CashInsufficientError extends Error {
    totalAmount;
    cashReceived;
    constructor(message, totalAmount, cashReceived) {
        super(message);
