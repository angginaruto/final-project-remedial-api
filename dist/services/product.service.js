...
// ============ CREATE PRODUCT ============
export const createProductService = async (userId, data, fileBuffer) => {
...
// ============ GET PRODUCTS ============
export const getProductsService = async (ownerAdminId, filters) => {
...
// ============ GET PRODUCT BY ID ============
export const getProductByIdService = async (ownerAdminId, id) => {
...
// ============ UPDATE PRODUCT ============
export const updateProductService = async (userId, id, data, fileBuffer) => {
